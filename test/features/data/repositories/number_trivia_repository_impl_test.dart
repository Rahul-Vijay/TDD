...
import 'package:capp/core/platform/network_info.dart';
...
import 'package:capp/features/number_trivia/data/repositories/number_trivia_repository_impl.dart';
...
void main() {
  ...
  group("getConcreteNumberTrivia", () {
    ...
    runTestsOnline(() {
        ...
        test(
            "should return server failure when call to the remote data source is unsuccessful",
            () async {
          // arrange
          when(mockRemoteDataSource.getConcreteNumberTrivia(tNumber))
